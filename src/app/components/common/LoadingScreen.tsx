    ...
    <AnimatePresence>
      {isLoading && (
        ...
        >
          ...
          >
            <motion.h1
              className="mbs:text-3xl mbl:text-4xl md:text-7xl font-extrabold bg-clip-text text-transparent 
            ...
            <motion.p
              className="mt-4 text-cyan-300 mbs:text-sm mbl:text-base md:text-lg tracking-wider font-mono"
