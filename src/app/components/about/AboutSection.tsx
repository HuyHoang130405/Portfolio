...
export default function AboutSection() {
  return (
    <section
      id="about"
      className="min-h-screen w-full mbs:px-4 sm:px-6 md:px-12 py-32 text-white overflow-x-hidden"
    >
      <FadeInWhenVisible>
        <div className="grid grid-cols-1 lg:grid-cols-12 mbl:gap-6 sm:gap-10 items-start w-full max-w-7xl mx-auto">
          ...
          >
            <div className="mbs:text-center lg:text-left">
              <h2 className="w-full mbs:mb-3 mbm:mb-5 mbs:text-[24px] mbm:text-[28px] mbl:text-3xl md:text-4xl font-bold text-[#38bdf8]">
                About Me
              </h2>
            ...
            {/* Nút */}
            <div className="flex gap-4 mbs:mb-8 mbl:mb-3 sm:mt-8 justify-center lg:justify-start">
              <a
                href="#"
                download
                className="mbs:text-sm sm:text-base px-5 py-2 border border-cyan-400/40 text-cyan-300 rounded-lg hover:bg-cyan-500/10 transition flex items-center gap-2"
              >
                Download CV
              </a>
              <a
